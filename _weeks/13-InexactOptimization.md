...
This week is a flex week in case we get behind earlier in the semester. If we do not need the extra time, we'll use this week to review the content we covered this semester and possibly cover a fun bonus topic (potentially evolutionary computation, see below).
